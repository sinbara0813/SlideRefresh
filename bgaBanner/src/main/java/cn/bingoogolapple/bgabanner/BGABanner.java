...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private static final int LWP = LinearLayout.LayoutParams.MATCH_PARENT;
    ...
    private RelativeLayout.LayoutParams pointContainerLp;
    ...
    private void initView(Context context) {
        ...
        pointContainerLp = new RelativeLayout.LayoutParams(RMP, RWC);
        // 处理圆点在顶部还是底部
    ...
    public void setPreData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.bga_banner_item_pre_image, models, tips);
    }

    public void setSpotData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.bga_banner_item_spot_image, models, tips);
    }
    ...
    public View getPreItemView(int position){
        return getItemView(position);
    }
    ...
    //动态设置指示器布局的位置
    public void setPointContainerMargin(int marginBottom) {
        pointContainerLp.setMargins(0, 0, 0, marginBottom);
        pointContainerRl.setLayoutParams(pointContainerLp);
    }
